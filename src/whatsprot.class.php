...
class WhatsProt
{
    ...
    const WHATSAPP_VER = '2.11.419';                // The WhatsApp version.
    const WHATSAPP_USER_AGENT = 'WhatsApp/2.11.419 Android/4.3 Device/GalaxyS3'; // User agent used in request/registration code.
